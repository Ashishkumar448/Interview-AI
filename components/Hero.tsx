  ...
  return (
    <section className="min-h-[90vh] flex  flex-col items-center px-8 justify-center relative">
      ...
      <div className="flex flex-col gap-6 items-center -mt-16 text-[var(--nav-text)]">
        <div className="w-56 relative -top-6 rounded-full border border-border bg-surface py-2 text-white/80 -mt-15">
          <h3 className="text-center text-sm font-medium tracking-wide">AI-Powered SaaS</h3>
        </div>
        <h1 className="font-extrabold max-sm:text-[40px] text-7xl text-center bg-clip-text text-transparent bg-gradient-to-b from-white to-white/50">
